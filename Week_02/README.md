...
| :--- | :--- | :--- |
| **Day 8** | **Conditionals** | Mastering `if`, `elif`, and `else` statements for logical decision-making. |
| **Day 9** | **For Loops** | Iterating over sequences and using the `range()` function efficiently. |
| **Day 10** | **While Loops** | Implementing infinite and conditional loops with `break` and `continue` keywords. |
| **Day 11** | **Nested Loops** | Building multi-dimensional logic for grids and complex data structures. |
| **Day 12** | **Pattern Practice** | Designing star, number, and pyramid patterns to sharpen algorithmic thinking. |
| **Day 13** | **Mini Project** | Developing a **Pattern Generator** that builds various shapes based on user input. |
| **Day 14** | **Review & GitHub** | Refactoring Week 1 & 2 code and maintaining documentation standards. |
